...
var   window_height = $(window).height(),
      testMobile,
	  loadingError = '<p class="error">El contenido no puede ser cargado.</p>',
	  nameError = '<div class="alert-message error">Por favor ingrese su nombre.<span class="close" href="#">x</span></div>',
	  emailError = '<div class="alert-message error">Por favor ingrese su correo electrónico<span class="close" href="#">x</span></div>',
	  invalidEmailError = '<div class="alert-message error">Por favor ingrese un correo electrónico valido.<span class="close" href="#">x</span></div>',	  
	  subjectError = '<div class="alert-message error">Por favor ingrese el asunto.<span class="close" href="#">x</span></div>',
	  messageError = '<div class="alert-message error">Por favor ingrese su mensaje..<span class="close" href="#">x</span></div>',	
	  mailSuccess = '<div class="alert-message success">Su mensaje ha sido enviado. ¡Gracias!<span class="close" href="#">x</span></div>', 
